...
<script type="text/javascript" src="{{ asset('js/dashboard/deviceModalController.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/dashboard/canvas-tipso.js') }}"></script>